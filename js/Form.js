class Form {
  ...
  display(){
    ...
    this.button2.hide();
    this.button2.position(displayWidth - 100, displayHeight - 175);
    ...
    this.button.mousePressed(()=>{
      ...
      if(this.input.value() === "Shyam" || this.input.value() === "shyam" && this.button.mousePressed){
        bg = loadImage('images/HBD_Masaji.png');
        ...
        video = createVideo("images/New video.mp4");
        flag=1
        positionFlag=1
        // console.log("IN")
